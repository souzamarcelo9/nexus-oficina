    ...
    <footer className="bg-matrix-bg text-gray-400 font-mono text-sm border-t border-matrix-green/10 relative overflow-hidden pt-16 pb-8">
      ...
      <div className="container mx-auto px-6 max-w-6xl grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
        ...
        <div className="md:col-span-4 space-y-4">
          ...
          {/* Redes Sociais Atualizadas (Apenas Instagram e WhatsApp) */}
          <div className="flex flex-col gap-3 pt-2">
            <p className="text-[10px] font-mono text-gray-500 uppercase tracking-widest">// CANAIS_DIRETOS</p>
            
            <div className="flex items-center gap-3">
              {/* Instagram (SVG Nativo) */}
              <motion.a
                href="https://www.instagram.com/nexus.oficina" // Substitua pelo link real do Instagram da oficina
                target="_blank"
              ...
              {/* WhatsApp Corporativo (SVG Nativo + Telefone) */}
              <motion.a
                href="https://wa.me/5521998761020?text=Ol%C3%A1!+Gostaria+de+agendar+um+atendimento+na+Nexus+Oficina."
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.02, x: 4 }}
                className="flex items-center gap-2.5 p-2 pr-4 bg-matrix-card border border-gray-800 rounded-md text-matrix-green hover:border-matrix-green shadow-sm hover:shadow-glow transition-all duration-300 group"
              >
                {/* Ícone do WhatsApp */}
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>
                </svg>
                {/* Número do Telefone com Estilo de Código */}
                <span className="text-xs font-mono text-gray-300 group-hover:text-matrix-green transition-colors">
                  (21) 99876-1020
                </span>
              </motion.a>
            </div>
